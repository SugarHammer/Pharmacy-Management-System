            ...
            $.ajax({
                ...
                success: function (res) {
                    if(res && res.code === 200){
                        ...
                        depotHeadID = data.id;
                        initTableData_material_show(TotalPrice,listSubType); //药品列表-查看状态
    ...
    function initTableData_material_show(TotalPrice,listSubType){
        ...
        $('#bill .materialDataShow').datagrid({
            ...
            columns:[[
                ...
                { title: '名称(备注)(扩展信息)(单位)',field: 'MaterialName',width:230},
                ...
                { title: '备注-别',field: 'OtherField2',editor:'validatebox',hidden:otherColumns,width:60},
