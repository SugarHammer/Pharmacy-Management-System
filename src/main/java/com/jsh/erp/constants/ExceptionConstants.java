...
public class ExceptionConstants {
    ...
    public static final String MATERIAL_PROPERTY_ADD_FAILED_MSG = "添加药品扩展信息失败";
    //删除药品扩展信息失败
    public static final int MATERIAL_PROPERTY_DELETE_FAILED_CODE = 6000001;
    public static final String MATERIAL_PROPERTY_DELETE_FAILED_MSG = "删除药品扩展信息失败";
    //修改药品扩展信息失败
    public static final int MATERIAL_PROPERTY_EDIT_FAILED_CODE = 6000002;
    public static final String MATERIAL_PROPERTY_EDIT_FAILED_MSG = "修改药品扩展信息失败";
    /**
     *  账户信息
     * type = 65
     * */
    ...
    public static final String MATERIAL_CATEGORY_ADD_FAILED_MSG = "添加药品类别信息失败";
    //删除药品类别信息失败
    public static final int MATERIAL_CATEGORY_DELETE_FAILED_CODE = 7500001;
    public static final String MATERIAL_CATEGORY_DELETE_FAILED_MSG = "删除药品类别信息失败";
    //修改药品类别信息失败
    public static final int MATERIAL_CATEGORY_EDIT_FAILED_CODE = 7500002;
    public static final String MATERIAL_CATEGORY_EDIT_FAILED_MSG = "修改药品类别信息失败";
    //药品类别编号已存在
    public static final int MATERIAL_CATEGORY_SERIAL_ALREADY_EXISTS_CODE = 7500003;
    public static final String MATERIAL_CATEGORY_SERIAL_ALREADY_EXISTS_MSG = "药品类别编号已存在";
    //根目录不支持修改
    ...
    public static final String MATERIAL_ADD_FAILED_MSG = "添加药品信息失败";
    //删除药品信息失败
    public static final int MATERIAL_DELETE_FAILED_CODE = 7500001;
    public static final String MATERIAL_DELETE_FAILED_MSG = "删除药品信息失败";
    //修改药品信息失败
    public static final int MATERIAL_EDIT_FAILED_CODE = 7500002;
    public static final String MATERIAL_EDIT_FAILED_MSG = "修改药品信息失败";
    //药品信息不存在
    public static final int MATERIAL_NOT_EXISTS_CODE = 8000000;
    public static final String MATERIAL_NOT_EXISTS_MSG = "药品信息不存在";
    //药品信息不唯一
    public static final int MATERIAL_NOT_ONLY_CODE = 8000001;
    public static final String MATERIAL_NOT_ONLY_MSG = "药品信息不唯一";
    //该药品未开启序列号
    public static final int MATERIAL_NOT_ENABLE_SERIAL_NUMBER_CODE = 8000002;
    public static final String MATERIAL_NOT_ENABLE_SERIAL_NUMBER_MSG = "该药品未开启序列号功能";
    //该药品已绑定序列号数量小于等于药品现有库存
    public static final int MATERIAL_SERIAL_NUMBERE_NOT_MORE_THAN_STORAGE_CODE = 8000003;
    public static final String MATERIAL_SERIAL_NUMBERE_NOT_MORE_THAN_STORAGE_MSG = "该药品已绑定序列号数量大于等于药品现有库存";
    //药品库存不足
    public static final int MATERIAL_STOCK_NOT_ENOUGH_CODE = 8000004;
    public static final String MATERIAL_STOCK_NOT_ENOUGH_MSG = "药品:%s库存不足";
    /**
     *  单据信息
     * type = 85
     * */
    ...
    public static final String MATERIAL_SERIAL_NUMBERE_NOT_ENOUGH_MSG = "药品:%s下序列号不充足，请补充后重试";
    /**删序列号信息失败*/
